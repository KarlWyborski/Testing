...
##        self.clock.grid(row=2,column=0)
    ...
    lCurrentTime = Label(self.leftLeftFrame, anchor=W, width = 7, height = 1)
...
##        win.destroy()
    ...
    def upButton(self):
        if self.bToggle:
            ...
            lAddTime.configure(text=self.iAddTime)
    ...
    def opButton(self):
        ...
        if self.bToggle:
            ...
            if self.iAddTime != 0:
                ...
                self.iAddTime = 0
                lCurrentTime.configure(text = str(self.iCurrentTime) + " - " + str(self.iCurrentTime+5))
        ...
        for l in f:
            ...
            if (l_sep[1] == str(today[0])) and (l_sep[2] == str(today[1])) and (l_sep[3] == str(today[2])):
                ...
                if i == 0:
                    ...
                    lCurrentTime.configure(text = str(self.iCurrentTime) + " - " + str(self.iCurrentTime+5))
                    lCurrentStamp.configure(text = l_sep[4] + ":" + l_sep[5] + "  " + am_pm)
                    
                    sHistTimes[i] = str(self.iCurrentTime) + " - " + str(self.iCurrentTime+5)
                    sHistStamps[i] = l_sep[4] + ":" + l_sep[5] + "  " + am_pm
                    
                    i += 1
                elif i < 5:
                    print("fixing hist row " + str(i))
                    lHistTimes[i-1].configure(text = l_sep[0] + " - " + str(int(l_sep[0])+5))
                    lHistStamps[i-1].configure(text = l_sep[4] + ":" + l_sep[5] + "  " + am_pm)
                    
                    sHistTimes[i] = l_sep[0] + " - " + str(int(l_sep[0])+5)
                    sHistStamps[i] = l_sep[4] + ":" + l_sep[5] + "  " + am_pm
